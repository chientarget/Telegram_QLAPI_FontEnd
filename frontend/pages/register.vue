      ...
      <a-form :model="formState" @finish="onFinish">
        ...
        <a-form-item>
          <a-checkbox v-model:checked="formState.agreeToTerms">
            Tôi đồng ý với <a href="#" class="text-red-600">Điều khoản và Chính sách bảo mật</a> bảo mật và xử lý dữ liệu cá nhân
          </a-checkbox>
        </a-form-item>
        <a-form-item>
        ...
        <a-button
            type="primary"
            html-type="submit"
            class="w-full bg-gray-600 hover:bg-gray-700 text-white rounded-none"
            :loading="loading"
        >
          Đăng ký
        </a-button>
